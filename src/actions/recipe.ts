...
【材料の記述ルール】
- 材料に「A」「B」「★」などの明確なグループラベルがある場合は、材料名にそのラベルを含めて記述すること（例：「A しょうゆ」、「★ 砂糖」）。
- **【重要】** ただし、「材料」「調味料」「手作りカレールー」などの単なる見出しや、料理名そのものがラベルとして使われている場合は、材料名に含めないでください。
- 材料名はシンプルに保ち、レシピに関連しない不要な単語を削除してください。
