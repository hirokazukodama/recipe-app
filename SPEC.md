...
**Version 2.2 | 2026.04版（Phase 2 実装完了版）**
...
> [!NOTE]
> **v2.1 → v2.2 改訂内容**: Phase 2 の全機能を実装完了し、以下の仕様を追記。
> - タグ管理および多対多リレーションのデータベース設計
> - URL / YouTube インポートと画像抽出の実装仕様
> - 登録済みレシピの編集・削除機能の追加
> - 人数変更に伴う分量の自動計算・分数表記（日本のレシピ形式）対応
> - AIによるハルシネーション防止と自動タグ提案・グループ分けラベリング機能
